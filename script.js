...
const generateStars = () =>
{
    ...
    const scales = new Float32Array(starsParameters.count)
...
const generateShootingStar = (x, y) =>
{
    ...
    const scales = new Float32Array(shootingStarParameters.count)
...
const tick = () =>
{
    ...
    {
        for (const element of shootingStars) {
            element.material.uniforms.uTime.value += deltaTime
            element.position.x += 0.04
